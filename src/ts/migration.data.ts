const CROSSWALK_TO_V20: Record<string, any> = {
  ...
  repeating_weapons: {
    additionalWeaponAttr1Name: 'weapon_attr1',
    additionalWeaponAttr2Name: 'weapon_attr2',
    additionalWeaponName: 'weapon_name',
    additionalWeaponCategory: 'weapon_category',
    additionalWeaponMartial: 'weapon_is_martial',
    additionalWeaponAccuracy: 'weapon_accuracy',
    additionalWeaponDamage: 'weapon_damage',
    additionalWeaponDamageType: 'weapon_type',
    additionalWeaponGrip: 'weapon_hands',
    additionalWeaponRange: 'weapon_range',
    additionalWeaponDescription: 'weapon_special',
  },
  ...
  repeating_rolls: {
    genericRollName: 'check_description',
